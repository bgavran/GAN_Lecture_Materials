...
\title[Generative Adversarial Networks]{Generative Adversarial Networks} % The short title appears at the bottom of every slide, the full title is only on the title page
...
{
Takelab internal seminars \\ % Your institution for the title page
\medskip
...
\begin{frame}[c]{ }
\centering
\href{https://www.youtube.com/watch?v=XOxxPcy5Gr4}{\beamergotobutton{Are you ready?}}
\end{frame}
