...
\begin{frame}
	...
	\begin{column}{0.5\textwidth}
		...
		\end{itemize}
		\begin{equation*}
			\onslide<7->{\mathbb{E}_{\bm{\hat{x}} \sim \mathbb{P}_{\bm{\hat{x}}}} \left[ \left(} \onslide<6->{\Vert} \nabla_{\bm{\hat{x}}} D(\bm{\hat{x}}) \onslide<6->{\Vert_2}  \onslide<7>{ - 1 \right)^2  \right]}
		\end{equation*}
	\end{column}
	\pause[4]
	\begin{column}{0.5\textwidth}  %%<--- here
